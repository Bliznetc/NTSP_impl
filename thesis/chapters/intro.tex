...
admitted in a directed graph~\cite{LalgudiPapaefthymiou1997}, and the
...
graphs~\cite{KrasikovNoble2004,Wu2010} and for planar directed
graphs~\cite{WuWang2015}; the general directed positively-weighted case was
...
\begin{enumerate}
  ...
  \item An empirical study of the CWZ algorithm's runtime on graphs from
    ...
    Yen-NSP as the practical baseline.
\end{enumerate}
...
implementation choices and why the $6$-tuple enumeration alone
suffices once the reduction emits a strictly layered graph. Chapter~\ref{ch:experiments} reports empirical
