...
complexity of $O(|V|^{4}|E|^{3}\log|V|)$. Our implementation uses the
Fortune--Hopcroft--Wyllie algorithm instead, which takes
$O(|V|^{2}+|V||E|)$ time per call (Section~\ref{sec:twovdp}).
